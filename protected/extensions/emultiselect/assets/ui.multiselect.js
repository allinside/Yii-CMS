...
$.widget("ui.multiselect", {
  options: {
	...
	_getOptionNode: function(option) {
		option = $(option);
		var node = $('<li value="' + option.attr('value') +'" class="ui-state-default ui-element" title="'+option.text()+'"><span class="ui-icon"/>'+option.text()+'<a href="#" class="action"><span class="ui-corner-all ui-icon"/></a></li>').hide();
