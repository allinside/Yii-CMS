<?php
//MORE SAFE TO SET PASSKEY
if(@$_GET['passkey']!=='mypass') die("You have no access to do it!");
...
$opts = array(
    //'root'            => '../../../../../images',  // path to root directory OR ABSOLUTE:
    'root'            => $_SERVER["DOCUMENT_ROOT"] . "/upload/pages/",                       // path to root directory
	'URL'             => '/upload/pages/', // root directory URL
